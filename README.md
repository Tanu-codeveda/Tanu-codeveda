...
* 🏆 **Hackathon Builder**: Developing scalable backend systems through real-world hackathons and collaborative engineering projects.
* 🛡️ **Securing the Future**: Actively deepening my knowledge in network security, threat analysis, and ethical hacking.
* 🤖 **AI meets Security**: Exploring how Machine Learning can enhance automated threat detection and intelligent automation.
* ☁️ **Cloud Infrastructure**: Learning how to deploy resilient and secure modern cloud environments.
* 💻 **Systems Thinker**: Passionate about Operating Systems, System Design, and building efficient backend architectures.
...
> *"Building scalable systems, writing clean code, and solving real-world problems—one project at a time."*
